    ...
    <section className="md:py-40 py-20" id="upgrade">
      <div className="container mx-auto lg:max-w-screen-xl px-4">
        <div className="grid lg:grid-cols-2 sm:gap-0 gap-10 items-center">
          <div>
            <p className="text-primary sm:text-28 text-18 mb-3">Vision</p>
            <h2 className="text-white sm:text-40 text-30  font-medium mb-5">
             Agridrone Vision
            </h2>
            <p className="text-muted text-opacity-60 text-18 mb-7">
            Notre vision pour l’Afrique est de révolutionner l’agriculture avec des drones de pulvérisation et de télédétection. Ces drones surveilleront en temps réel des hectares de terres, détectant les signes de maladies et de stress hydrique. Les traitements seront appliqués de manière précise, réduisant l’utilisation de pesticides et d’engrais.
            </p>
