      ...
      <div className="container mx-auto lg:max-w-screen-xl px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            ...
            Govathon  <span className="text-primary">2024 <span className="text-primary">🏆 !</span></span>
            </p>
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              {/* Create your crypto portfolio today with Cryp */}
              <span className="text-primary">NOUS L'AVONS FAIT !</span>
            </h2>
            <p className="text-muted text-opacity-60 text-18">
            Fiers d'avoir décroché la 3ème place du Govathon 🏆 ! Une aventure collective où innovation et engagement ont brillé – merci à notre équipe et à tous les acteurs de ce défi inspirant ! #Govathon #Hackathon #Podium
