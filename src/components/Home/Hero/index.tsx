...
import { floatAnimation, itemAnimation } from "./animations";
...
const Hero = () => {
  ...
  return (
    ...
    >
      <motion.div variants={itemAnimation} className="flex gap-6 items-center lg:justify-start justify-center mb-5 mt-24">
        <Image 
          ...
          height={40}
        />
        <p className="text-white sm:text-23 mb-0 ">
  Revolutionnez votre agriculture <span className="text-primary sm:text-28" >Go</span>
</p>
      </motion.div>

      <motion.h1 variants={itemAnimation} className="font-medium lg:text-76 md:text-70 text-54 lg:text-start text-center text-white mb-10">
        AgriDrone <span className="text-primary">Vision</span> 
      </motion.h1>

      <motion.div variants={itemAnimation} className="flex items-center md:justify-start justify-center gap-8">
        <motion.button
      ...
      {/* <motion.div variants={itemAnimation} className="flex items-center md:justify-start justify-center gap-12 mt-20">
        <Link href="#">
